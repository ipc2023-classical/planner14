...
//3) open[other->g] <-- other.frontier
    if(!other->Sfilter.empty()) open_list.insert(other->Sfilter, other->g);
    if(!other->Smerge.empty()) open_list.insert(other->Smerge, other->g);
    if(!other->S.empty()) open_list.insert(other->S, other->g);
