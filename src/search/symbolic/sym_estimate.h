#ifndef SYMBOLIC_STEP_COST_ESTIMATION_H
#define SYMBOLIC_STEP_COST_ESTIMATION_H
...
class SymStepCostEstimation{
 ...
 public:
  ...
  friend std::ostream & operator<<(std::ostream &os, const SymStepCostEstimation & est);
